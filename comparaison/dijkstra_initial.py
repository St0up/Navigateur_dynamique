...
def dijkstra_initial(initial, arrivee, graphe, t):
    """
    ...
    for loop in range(n):
        ...
        for i in adjoint:
            duree = (graphe.arete)[i].temps(t)                 # duree entre les deux sommets, faire attention à faire la différence entre la fonction temps et la liste
